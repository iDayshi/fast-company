...
const professionsSlice = createSlice({
  ...
  reducers: {
    ...
    professionsRequestFieled: (state, action) => {
...
const { professionsRequested, professionsReceved, professionsRequestFieled } =
  actions;
...
export const loadingProfessionsList = () => async (dispatch, getState) => {
  ...
  if (isOutdated(lastFetch)) {
    ...
    try {
      ...
      dispatch(professionsRequestFieled(error.message));
    }
  }
};
